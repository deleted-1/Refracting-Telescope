...
def set_parameters():
    ...
    def show_diagram():
        try:    
            ...
            elif int(len_distance.get())-int(focal_ocular.get()) <= focal_objective | int(focal_ocular.get()) <= 0: Label(root, text="Please enter a larger focal ocular.", font=("time new roman",10), fg='red').place(x=325,y=95) 
