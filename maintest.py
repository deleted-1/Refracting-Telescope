...
def main(height_object=70,distance_object=100,focal_length1=50,focal_length2=20,distance_ocular=150,distance_objective=450):
    ...
    height_image2 = ()
    magnefication = -distance_image2/distance_image1
    ...
    objective = pg.draw.ellipse(background,(135, 206, 235),[distance_objective,450-int(500*.5),25,500],0)
    ocular = pg.draw.ellipse(background,(135, 206, 235),[distance_ocular,450-int(350*.5),25,350],0)
    ...
    while True:
        ...
        screen.blit(object_, (450-distance_object*1.5, 450-height_object))
        if real_image_drawn == False and y1 >= height_image1+450 and y2 >= height_image1+450 and y3 >= height_image1+450:
            ...
            real_image.convert()
            print('The size of the real image is {}cm and is {}cm away from the ocular lens.'.format(height_image1,distance_ocular-distance_image1-450))
            screen.blit(real_image,[int(450+distance_image1),int(450)])
        elif real_image_drawn == True: screen.blit(real_image,[int(450+distance_image1),int(450)])
